...
后续工作将集中在三方面：其一，补齐 SOC 精度与 Randomized 全量动态负载指标；其二，继续补充 zero-shot 泛化图和真实电站定性图；其三，将 Python 包级策略轨迹接入可信 Simulink / Simscape pack plant，完成电路级均衡验证。
...
| 图 15 | Zenodo 6985321 zero-shot SOC/SOH 曲线 | 缺失 | 待生成 |
| 图 16 | Zenodo 18471156 真实电站定性图 | 缺失 | 数据未下载 |
