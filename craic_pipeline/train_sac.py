...
def main():
    ...
    parser.add_argument("--reward-speed", type=float, default=30.0)
    parser.add_argument("--reward-voltage", type=float, default=300.0)
    parser.add_argument("--reward-temperature", type=float, default=0.02)
    parser.add_argument("--reward-aging", type=float, default=120.0)
